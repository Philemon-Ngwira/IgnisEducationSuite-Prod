...
namespace EduSphereDomain.FinanceData
{
    public partial class PhoenixEdusphereFinanceContext
    {
        ...
        protected void OnModelCreatingGeneratedProcedures(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<GetSchoolReportCardsResult>().HasNoKey().ToView(null);
            ...
            modelBuilder.Entity<GetTeacherStudentCompletionStatusResult>().HasNoKey().ToView(null);
            ...
            modelBuilder.Entity<usp_GetTeacherBusySlotsResult>().HasNoKey().ToView(null);
    ...
    public partial class PhoenixEdusphereFinanceContextProcedures : IPhoenixEdusphereFinanceContextProcedures
    {
        ...
        public virtual async Task<List<GetSchoolReportCardsResult>> GetSchoolReportCardsAsync(Guid? SchoolID, Guid? AcademicLevelID, string GradeSection, string Term, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryAsync<GetSchoolReportCardsResult>("EXEC @returnValue = [dbo].[GetSchoolReportCards] @SchoolID, @AcademicLevelID, @GradeSection, @Term", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<GetTeacherStudentCompletionStatusResult>> GetTeacherStudentCompletionStatusAsync(Guid? SchoolID, Guid? TeacherID, string ReportCardType, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryAsync<GetTeacherStudentCompletionStatusResult>("EXEC @returnValue = [dbo].[GetTeacherStudentCompletionStatus] @SchoolID, @TeacherID, @ReportCardType", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<usp_GetTeacherBusySlotsResult>> usp_GetTeacherBusySlotsAsync(Guid? TeacherID, Guid? SchoolID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryAsync<usp_GetTeacherBusySlotsResult>("EXEC @returnValue = [dbo].[usp_GetTeacherBusySlots] @TeacherID, @SchoolID", sqlParameters, cancellationToken);
